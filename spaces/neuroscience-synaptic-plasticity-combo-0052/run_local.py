#!/usr/bin/env python3
"""Run generated space: neuroscience-synaptic-plasticity-combo-0052."""
...
def _repo_root_map(current_repo_root: Path) -> dict[str, Path]:
    ...
    return {
        "Biosimulant/models-neuroscience-other-02": current_repo_root.resolve(),
...
def main() -> None:
    ...
    print(f"Completed {space.get('title', 'neuroscience-synaptic-plasticity-combo-0052')} duration={duration} tick_dt={tick_dt}")
