...
"""Auto-generated BioModule wrapper for A Method for Prediction of Receptor Activation in the Simulation of Synapses (Montes et al. 2013).

Source: modeldb:150207
Original: https://modeldb.science/150207
Standard: other
...
class OtherAMethodForPredictionOfReceptorActivationInThe(biosim.BioModule):
    """BioModule wrapper for: A Method for Prediction of Receptor Activation in the Simulation of Synapses (Montes et al. 2013)."""

    def __init__(self, model_path: str = "data/150207.zip", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
AMethodForPredictionOfReceptorActivationI150207Model = OtherAMethodForPredictionOfReceptorActivationInThe
