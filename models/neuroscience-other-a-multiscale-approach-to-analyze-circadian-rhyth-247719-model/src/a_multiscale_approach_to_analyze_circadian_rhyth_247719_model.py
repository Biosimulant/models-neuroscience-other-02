...
"""Auto-generated BioModule wrapper for A multiscale approach to analyze circadian rhythms (Vasalou & Henson, 2010) (SBML).

Source: modeldb:247719
Original: https://modeldb.science/247719
Standard: other
...
class OtherAMultiscaleApproachToAnalyzeCircadianRhythmsVasalou2(bsim.BioModule):
    """Placeholder BioModule wrapper for: A multiscale approach to analyze circadian rhythms (Vasalou & Henson, 2010) (SBML).
...
AMultiscaleApproachToAnalyzeCircadianRhyth247719Model = OtherAMultiscaleApproachToAnalyzeCircadianRhythmsVasalou2
