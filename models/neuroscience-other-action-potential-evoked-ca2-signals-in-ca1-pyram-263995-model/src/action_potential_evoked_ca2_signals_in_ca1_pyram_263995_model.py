...
"""Auto-generated BioModule wrapper for Action potential-evoked Ca2+ signals in CA1 pyramidal cell presynaptic terminals (Hamid et al 2019).

Source: modeldb:263995
Original: https://modeldb.science/263995
Standard: other
...
class OtherActionPotentialEvokedCa2SignalsInCa1PyramidalCell(biosim.BioModule):
    """BioModule wrapper for: Action potential-evoked Ca2+ signals in CA1 pyramidal cell presynaptic terminals (Hamid et al 2019).""""""

    def __init__(self, model_path: str = "data/263995.zip", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
ActionPotentialEvokedCa2SignalsInCa1Pyram263995Model = OtherActionPotentialEvokedCa2SignalsInCa1PyramidalCell
