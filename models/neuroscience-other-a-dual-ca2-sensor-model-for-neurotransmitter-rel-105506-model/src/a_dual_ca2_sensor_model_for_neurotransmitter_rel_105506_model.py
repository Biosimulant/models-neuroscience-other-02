...
"""Auto-generated BioModule wrapper for A dual-Ca2+-sensor model for neurotransmitter release in a central synapse (Sun et al. 2007).

Source: modeldb:105506
Original: https://modeldb.science/105506
Standard: other
...
class OtherADualCa2SensorModelForNeurotransmitterReleaseInA(bsim.BioModule):
    """Placeholder BioModule wrapper for: A dual-Ca2+-sensor model for neurotransmitter release in a central synapse (Sun et al. 2007).
...
ADualCa2SensorModelForNeurotransmitterRel105506Model = OtherADualCa2SensorModelForNeurotransmitterReleaseInA
