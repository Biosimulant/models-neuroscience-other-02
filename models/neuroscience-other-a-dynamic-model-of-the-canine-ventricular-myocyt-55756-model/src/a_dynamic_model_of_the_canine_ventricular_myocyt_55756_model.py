...
"""Auto-generated BioModule wrapper for A dynamic model of the canine ventricular myocyte (Hund, Rudy 2004).

Source: modeldb:55756
Original: https://modeldb.science/55756
Standard: other
...
class OtherADynamicModelOfTheCanineVentricularMyocyteHundRudy(bsim.BioModule):
    """Placeholder BioModule wrapper for: A dynamic model of the canine ventricular myocyte (Hund, Rudy 2004).
...
ADynamicModelOfTheCanineVentricularMyocyt55756Model = OtherADynamicModelOfTheCanineVentricularMyocyteHundRudy
