...
"""Auto-generated BioModule wrapper for ACnet2.

Source: opensourcebrain:ACnet2
Original: https://github.com/OpenSourceBrain/ACnet2
Standard: other
...
class OtherAcnet2(biosim.BioModule):
    """Placeholder BioModule wrapper for: ACnet2.
