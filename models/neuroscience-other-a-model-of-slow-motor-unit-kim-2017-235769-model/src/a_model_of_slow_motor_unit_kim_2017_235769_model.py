...
"""Auto-generated BioModule wrapper for A model of slow motor unit (Kim, 2017).

Source: modeldb:235769
Original: https://modeldb.science/235769
Standard: other
...
class OtherAModelOfSlowMotorUnitKim2017(biosim.BioModule):
    """Placeholder BioModule wrapper for: A model of slow motor unit (Kim, 2017).
    ...
    def __init__(self, model_path: str = "data/235769.zip", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
AModelOfSlowMotorUnitKim2017235769Model = OtherAModelOfSlowMotorUnitKim2017
