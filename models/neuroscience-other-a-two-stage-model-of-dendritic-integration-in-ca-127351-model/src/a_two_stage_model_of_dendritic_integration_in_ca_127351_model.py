...
"""Auto-generated BioModule wrapper for A two-stage model of dendritic integration in CA1 pyramidal neurons (Katz et al. 2009).

Source: modeldb:127351
Original: https://modeldb.science/127351
Standard: other
...
class OtherATwoStageModelOfDendriticIntegrationInCa1Pyramidal(biosim.BioModule):
    """BioModule wrapper for: A two-stage model of dendritic integration in CA1 pyramidal neurons (Katz et al. 2009).""""""

    def __init__(self, model_path: str = "data/127351.zip", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
ATwoStageModelOfDendriticIntegrationInCa127351Model = OtherATwoStageModelOfDendriticIntegrationInCa1Pyramidal
