...
"""Auto-generated BioModule wrapper for A model of neuronal bursting using three coupled first order diff. eqs. (Hindmarsh & Rose 1984).

Source: modeldb:247196
Original: https://modeldb.science/247196
Standard: other
...
class OtherAModelOfNeuronalBurstingUsingThreeCoupledFirst(bsim.BioModule):
    """Placeholder BioModule wrapper for: A model of neuronal bursting using three coupled first order diff. eqs. (Hindmarsh & Rose 1984).
...
AModelOfNeuronalBurstingUsingThreeCoupled247196Model = OtherAModelOfNeuronalBurstingUsingThreeCoupledFirst
