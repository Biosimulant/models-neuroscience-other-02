...
"""Auto-generated BioModule wrapper for Active zone model of Ca2+ secretion coupling (Keller et al. 2015).

Source: modeldb:182142
Original: https://modeldb.science/182142
Standard: other
...
class OtherActiveZoneModelOfCa2SecretionCouplingKellerEtAl(biosim.BioModule):
    """BioModule wrapper for: Active zone model of Ca2+ secretion coupling (Keller et al. 2015)."""

    def __init__(self, model_path: str = "data/182142.zip", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
ActiveZoneModelOfCa2SecretionCouplingKell182142Model = OtherActiveZoneModelOfCa2SecretionCouplingKellerEtAl
