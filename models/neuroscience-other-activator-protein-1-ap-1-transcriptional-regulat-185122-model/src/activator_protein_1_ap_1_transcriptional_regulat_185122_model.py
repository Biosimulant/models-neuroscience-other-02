...
"""Auto-generated BioModule wrapper for Activator protein 1(AP-1) transcriptional regulatory model in brainstem neurons (Makadia et al 2015).

Source: modeldb:185122
Original: https://modeldb.science/185122
Standard: other
...
class OtherActivatorProtein1Ap1TranscriptionalRegulatoryModel(biosim.BioModule):
    """BioModule wrapper for: Activator protein 1(AP-1) transcriptional regulatory model in brainstem neurons (Makadia et al 2015)."""

    def __init__(self, model_path: str = "data/185122.zip", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
ActivatorProtein1Ap1TranscriptionalRegulat185122Model = OtherActivatorProtein1Ap1TranscriptionalRegulatoryModel
