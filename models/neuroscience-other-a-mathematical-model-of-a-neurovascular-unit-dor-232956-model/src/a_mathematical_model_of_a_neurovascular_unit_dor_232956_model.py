...
"""Auto-generated BioModule wrapper for A mathematical model of a neurovascular unit (Dormanns et al 2015, 2016) (Farrs & David 2011).

Source: modeldb:232956
Original: https://modeldb.science/232956
Standard: other
...
class OtherAMathematicalModelOfANeurovascularUnitDormannsEtAl(biosim.BioModule):
    """BioModule wrapper for: A mathematical model of a neurovascular unit (Dormanns et al 2015, 2016) (Farrs & David 2011)."""

    def __init__(self, model_path: str = "data/232956.zip", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
AMathematicalModelOfANeurovascularUnitDor232956Model = OtherAMathematicalModelOfANeurovascularUnitDormannsEtAl
