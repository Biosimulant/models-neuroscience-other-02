...
"""Auto-generated BioModule wrapper for Action potential-evoked Na+ influx similar in axon and soma (Fleidervish et al. 2010) (Python).

Source: modeldb:249404
Original: https://modeldb.science/249404
Standard: other
...
class OtherActionPotentialEvokedNaInfluxSimilarInAxonAndSoma(biosim.BioModule):
    """BioModule wrapper for: Action potential-evoked Na+ influx similar in axon and soma (Fleidervish et al. 2010) (Python)."""

    def __init__(self, model_path: str = "data/249404.zip", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
ActionPotentialEvokedNaInfluxSimilarInAxo249404Model = OtherActionPotentialEvokedNaInfluxSimilarInAxonAndSoma
